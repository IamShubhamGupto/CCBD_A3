...
public class GreenCount {
  ...
  public static class TokenizerMapper
    ...
    public void map(Object key, Text value, Context context)
		...
		if(CONSTANT.USE_PERCENTILE){
			Text word1 = new Text("Greater than 90th Percentile");
			Text word2 = new Text("Lesser than 90th Percentile");
			if(green >= 0.34670276880076900)
				context.write(word1, one);
			else
				context.write(word2, one);
		}else{
			Text word1 = new Text("Greater than 75%");
			Text word2 = new Text("Lesser than 75%");
